<script lang="ts">
  ...
  import SettingPanelTokenAmount from "@pulse/reusable-parts/SettingPanelTokenAmount.svelte";
  import {isSmallDevice, minDatePickerDate} from "@pulse/shared/computed.ts";
